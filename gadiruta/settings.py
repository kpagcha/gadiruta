"""
Django settings for gadiruta project.
...
WSGI_APPLICATION = "gadiruta.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "gadiruta"),
        "USER": os.environ.get("POSTGRES_USER", "gadiruta"),
